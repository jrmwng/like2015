...
namespace jrmwng
{
	...
	template <typename TR, typename TS, typename TV>
	struct member_t<TR, TV(TS::*)>
		: member_t<TR>
	{
		typedef member_t<TR> base_type;
		typedef std::conditional_t<std::is_void<TR>::value, TV, TR> result_type;

		typedef TV(TS::*TM);

		TM const m_tM;

		member_t(TM const & tM)
			: m_tM(tM)
		{}
	...
	{
		typedef member_t<TR> base_type;
		typedef typename std::conditional<std::is_void<TR>::value, TV, TR>::type result_type;
	...
	template <typename TR, typename TS, typename TV>
	struct member_t<TR, TV(TS::*)()const>
		: member_t<TR>
	{
		typedef member_t<TR> base_type;
		typedef typename std::conditional<std::is_void<TR>::value, TV, TR>::type result_type;

		typedef TV(TS::*TM)()const;
	...
	template <typename TR, typename TS, typename TV>
	struct member_t<TR, TV(TS::*)()volatile>
		: member_t<TR>
	{
		typedef member_t<TR> base_type;
		typedef typename std::conditional<std::is_void<TR>::value, TV, TR>::type result_type;

		typedef TV(TS::*TM)()volatile;
	...
	template <typename TR, typename TS, typename TV>
	struct member_t<TR, TV(TS::*)()const volatile>
		: member_t<TR>
	{
		typedef member_t<TR> base_type;
		typedef typename std::conditional<std::is_void<TR>::value, TV, TR>::type result_type;

		typedef TV(TS::*TM)()const volatile;
	...
	struct order_by_t
	{
		...
		bool operator () (typename TM::result_type const & t1, typename TM::result_type const & t2) const
		{
			return m_tOrder(t1, t2);
		}
		template <typename T1>
		bool operator () (T1 const & t1, typename TM::result_type const & t2) const
		{
			return m_tOrder(m_tM(t1), t2);
		}
		template <typename T2>
		bool operator () (typename TM::result_type const & t1, T2 const & t2) const
		{
