...
void ::App1::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::App1::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 3:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::App1::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::App1::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
